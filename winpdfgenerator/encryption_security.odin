...
Security_Handler :: struct {
	user_password, owner_password: string,
...
Encryption_Context :: struct {
	perms_value: [16]byte,
	file_key, oe_value, ue_value: [32]byte,
	o_value, u_value: [48]byte,
	p_raw: i32,
	encrypt_metadata: bool,
}
...
write_encrypt_dict :: proc(sb: ^strings.Builder, id: int, ctx: ^Encryption_Context) {
	...
	if !ctx.encrypt_metadata {
		fmt.sbprintf(sb, "  /EncryptMetadata false\n")
	}
